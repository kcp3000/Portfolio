...
//https://www.figma.com/design/6L5bqgxITuRmqeQamyhmcH/We-Will-Thru-Sports?node-id=43-3&t=MMzXl2W8h06k21UB-1
  ...
  return <>
    ...
    <div className="mobileview_projects">
      <SlideAnimateY delay={2.5} yH={50}>
        <p className="switch">PRESS TO SWITCH</p>
      </SlideAnimateY>
      <SlideAnimateY delay={2} yH={50}>
        <button className="projectSwitch" onClick={toggleChange}>{isChanged ? "SWE" : "DESIGN"}</button>
      </SlideAnimateY>
      {isChanged ? (
    ...
    <section className="project_container">
      <div className="design_container">
        <SlideAnimateY delay={1.5} yH={50}>
          <h1 className="inner_text">DESIGN</h1>
        </SlideAnimateY>
